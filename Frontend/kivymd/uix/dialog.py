	...
	BoxLayout:
		...
		ScrollView:
			...
			MDList:
				...
				ThinBox:
					ThinLabel:
						text: "Possibility of Rain in mm "
					ThinLabelButton:
						text: root.Possibility_of_Rain1
				ThinBox:
					ThinLabel:
						text: "Water to be Irrigated "
					ThinLabelButton:
						text: root.Water_to_be_Irrigated1
				ThinBox:
					ThinLabel:
						text: ""
					ThinLabelButton:
				...
				ThinBox:
					ThinLabel:
						text: "Possibility of Rain in mm "
					ThinLabelButton:
						text: root.Possibility_of_Rain2
				ThinBox:
					ThinLabel:
						text: "Water to be Irrigated "
					ThinLabelButton:
						text: root.Water_to_be_Irrigated2
				ThinBox:
					ThinLabel:
						text: ""
					ThinLabelButton:
				...
				ThinBox:
					ThinLabel:
						text: "Possibility of Rain in mm "
					ThinLabelButton:
						text: root.Possibility_of_Rain3
				ThinBox:
					ThinLabel:
						text: "Water to be Irrigated "
					ThinLabelButton:
						text: root.Water_to_be_Irrigated3
				ThinBox:
					ThinLabel:
						text: ""
					ThinLabelButton:
				...
				ThinBox:
					ThinLabel:
						text: "Possibility of Rain in mm "
					ThinLabelButton:
						text: root.Possibility_of_Rain4
				ThinBox:
					ThinLabel:
						text: "Water to be Irrigated "
					ThinLabelButton:
						text: root.Water_to_be_Irrigated4
				ThinBox:
					ThinLabel:
						text: ""
					ThinLabelButton:
				...
				ThinBox:
					ThinLabel:
						text: "Possibility of Rain in mm "
					ThinLabelButton:
						text: root.Possibility_of_Rain5
				ThinBox:
					ThinLabel:
						text: "Water to be Irrigated "
					ThinLabelButton:
						text: root.Water_to_be_Irrigated5
				ThinBox:
					ThinLabel:
						text: ""
					ThinLabelButton:
				...
				ThinBox:
					ThinLabel:
						text: "Possibility of Rain in mm "
					ThinLabelButton:
						text: root.Possibility_of_Rain6
				ThinBox:
					ThinLabel:
						text: "Water to be Irrigated "
					ThinLabelButton:
						text: root.Water_to_be_Irrigated6
				ThinBox:
					ThinLabel:
						text: ""
					ThinLabelButton:
				...
				ThinBox:
					ThinLabel:
						text: "Possibility of Rain in mm "
					ThinLabelButton:
						text: root.Possibility_of_Rain7
				ThinBox:
					ThinLabel:
						text: "Water to be Irrigated "
					ThinLabelButton:
						text: root.Water_to_be_Irrigated7
...
class ListMDDialog(BaseDialog):
	...
	Date1= StringProperty("Missing data")
	Possibility_of_Rain1 = StringProperty("Missing data")
	Water_to_be_Irrigated1 = StringProperty("Missing data")
   
	Date2= StringProperty("Missing data")
	Possibility_of_Rain2 = StringProperty("Missing data")
	Water_to_be_Irrigated2 = StringProperty("Missing data")
	
	Date3= StringProperty("Missing data")
	Possibility_of_Rain3 = StringProperty("Missing data")
	Water_to_be_Irrigated3 = StringProperty("Missing data")

	Date4= StringProperty("Missing data")
	Possibility_of_Rain4 = StringProperty("Missing data")
	Water_to_be_Irrigated4 = StringProperty("Missing data")

	Date5= StringProperty("Missing data")
	Possibility_of_Rain5 = StringProperty("Missing data")
	Water_to_be_Irrigated5 = StringProperty("Missing data")

	Date6= StringProperty("Missing data")
	Possibility_of_Rain6 = StringProperty("Missing data")
	Water_to_be_Irrigated6 = StringProperty("Missing data")

	Date7= StringProperty("Missing data")
	Possibility_of_Rain7 = StringProperty("Missing data")
	Water_to_be_Irrigated7 = StringProperty("Missing data")
